...
@app.route('/politics_personalinf_copy')
def politics_personalinf_copy():
    authenticated = False
    if current_user.is_authenticated:
        authenticated = True
    return render_template('base/politics_personalinf_copy.html', authenticated=authenticated, title=1)
