...
class Quiz
{
    ...
    Check_result(ochki)
    {
       ...
       for(var i = 0; i < this.ochki.length; ++i)
       {
        ...
        var ans_rabota_ludi="", ans_issledovanya=" ", ans_prakt_deyat=" ", ans_estetik=" ", ans_ekstrim=" ", ans_plan=" ", ans_all, ans1='';
        ...
        if(plan < 4)
        {
             ans1 = "Профессиональная склонность не выражена.\n\n";
             ans_plan+= ans1;
        }
        else if(3<plan<7)
        {
        ...
        {
             ans1+="Присутствует склонность к этому виду деятельности.\n\n";
             ans_plan+= ans1;
        }
        else
        {
             ans1+="Ярко выраженная профессиональная склонность.\n\n";
             ans_plan+= ans1;
        }
        ...
        {
             ans1+="Слабо выраженная профессиональная склонность.\n\n";
             ans_ekstrim+= ans1;
        }
        else if(6<ekstrim<10)
        {
             ans1+="Присутствует склонность к этому виду деятельности.\n\n";
             ans_ekstrim+= ans1;
        }
        ...
        {
             ans1+="Профессиональная склонность не выражена.\n\n";
             ans_prakt_deyat+= ans1;
        }
        else if(3<prakt_deyat<7)
        {
             ans1+="Слабо выраженная профессиональная склонность.\n\n";
             ans_prakt_deyat+= ans1;
        }
        else if(6<prakt_deyat<10)
        {
             ans1+="Присутствует склонность к этому виду деятельности.\n\n";
             ans_prakt_deyat+= ans1;
        }
        ...
        {
             ans1+="Профессиональная склонность не выражена.\n\n";
             ans_issledovanya+= ans1;
        }
        else if(3<issledovanya<7)
        {
             ans1+="Слабо выраженная профессиональная склонность.\n\n";
             ans_issledovanya+= ans1;
        }
        else if(6<issledovanya<10)
        {
             ans1+="Присутствует склонность к этому виду деятельности.\n\n";
             ans_issledovanya+= ans1;
        }
        ...
        {
             ans1+="Профессиональная склонность не выражена.\n\n";
             ans_rabota_ludi+= ans1;
        }
        else if(3<rabota_ludi<7)
        {
             ans1+="Слабо выраженная профессиональная склонность.\n\n";
             ans_rabota_ludi+= ans1;
        }
        else if(6<rabota_ludi<10)
        {
             ans1+="Присутствует склонность к этому виду деятельности.\n\n";
             ans_rabota_ludi+= ans1;
        }
